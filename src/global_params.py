params = {
	...
	'constant_error_rate_upper': 0.005, #TODO: lets get back to a range but for now we want things to start working...
	'n_genetic_epochs': 10,
	...
	'n_decoder_rounds': 5_000, #TODO: change back to higher
	'p_skip_mutation': 0.8,
