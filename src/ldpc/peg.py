# The following code is almost 1 to 1 with https://github.com/manuts/gr-ldpc/blob/63cca16bd4020fae01a983882dc314b0862da982/apps/peg.py#L23
# The code from the above link has a GNU license
import numpy as np
import copy
